      ...
      <div className="grid grid-cols-2 w-full md:w-1/2 md:grid-cols-2">
        ...
        <div className='space-y-[40px] mt-28 ml-16'>
          <img
            ...
            alt="Small Image"
            className="rounded-[20px] ml-[100px] w-32 h-32 md:w-48 md:h-36 object-cover"
          />
          <img
            src="https://gatoes.com/assets/images/img-2.jpg"
            alt="Large Image"
            className="rounded-[20px] ml-[40px] w-48 h-40 object-cover"
          />
        </div>
        ...
        <div className='space-y-10 '>
          ...
          <img
            ...
            alt="Large Image 3"
            className="rounded-[20px] w-72 h-72 ml-12 object-cover"
          />
          <img
            src="https://gatoes.com/assets/images/img-3.jpg"
            alt="Large Image 2"
            className="rounded-[20px] w-72 h-52 md:w-96 md:h-52 object-cover"
          />
